...
class People(db.Model):
    ...
    favorited_by_users: Mapped[list["Favorite"]] = relationship(back_populates="people")
...
class Favorite(db.Model):
    ...
    people: Mapped["People"] = relationship(back_populates="favorited_by_users", foreign_keys=[people_id])
